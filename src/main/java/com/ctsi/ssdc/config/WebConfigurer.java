...
public class WebConfigurer implements ServletContextInitializer, WebServerFactoryCustomizer<WebServerFactory> {
    ...
    public WebConfigurer(Environment env, CtsiProperties ctsiProperties) {
    ...
    public void customize(WebServerFactory server) {
         ...
         * See the CtsiProperties class and your application-*.yml configuration files
         * for more information.
         */
//        if (ctsiProperties.getHttp().getVersion().equals(CtsiProperties.Http.Version.V_2_0) &&
...
//                new CachingHttpHeadersFilter(ctsiProperties));
//
...
//        metricsAdminServlet.setLoadOnStartup(2);
    ...
    public CorsFilter corsFilter() {
        ...
        CorsConfiguration config = ctsiProperties.getCors();
        if (config.getAllowedOriginPatterns() != null && !config.getAllowedOriginPatterns().isEmpty()) {
            log.debug("Registering CORS filter");
            
            List<String> paths = ctsiProperties.getCorspaths();
